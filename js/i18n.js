...
(function (root, factory) {
  ...
  var STRINGS = {
    en: {
      ...
      'ch1.body': 'It started with static, a flicker, and a green cursor blinking on a curved glass screen. My family’s first computer was not much: a CRT monitor that hummed before it glowed, a boot screen that took its time, and a keyboard that felt like a machine’s own language. I did not know a single technical term yet. I only knew that whatever lived inside that beige box obeyed the words I typed. That was the moment the questions started: what else can I make it do?',
    ...
    es: {
      ...
      'ch1.body': 'Todo arrancó con estática, un parpadeo y un cursor verde titilando en una pantalla curva. La primera computadora de mi familia no era gran cosa: un monitor CRT que zumbaba antes de prender, una pantalla de arranque que se tomaba su tiempo, y un teclado que parecía el idioma propio de una máquina. Todavía no conocía ni un término técnico. Solo sabía que lo que vivía dentro de esa caja beige obedecía las palabras que yo escribía. Ahí empezaron las preguntas: ¿qué más puedo hacer con ella?',
      ...
      'ch6.r1': 'ingeniero de software junior', 'ch6.rs1': 'e.tres (luego Lytx) · integraciones con pasarelas de pago',
      'ch6.r2': 'consultor', 'ch6.rs2': 'endpoint de datos masivos, −80% tiempo de proceso · fixes cross-layer',
      'ch6.r3': 'ingeniero de software senior', 'ch6.rs3': 'GlobalLogic (Coalfire) · microservicio .NET 9, 30% más rápido bajo carga',
      'ch6.r4': 'pagos, mejorados', 'ch6.rs4': 'patrones CQRS + Mediator en un microservicio de pagos',
